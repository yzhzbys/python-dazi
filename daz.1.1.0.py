...
grades=Text(hh,width=80,height=7,state='disable')
...
class typing:
    ...
    def __init__(self):
        self.clock=[]   
        self.titstr=''
        self.string_all=open('文章.txt','r')
        self.titnum=80#此处设置字数
        self.string_tit=self.string_all.read(self.titnum)
        self.check=''
        self.check_tt=''
        self.all_spd=0#当前速度
    ...
    def create(self):
        ...
        self.titstr=''.join(self.string_tit)
        v1.set(self.titstr)
