...
tit1=Text(hh,fg='#78a2a1',bg='#68312e',state='disabled',width=80,height=1,font=('楷体',10,'bold'))
tit2=Text(hh,fg='#ccc',state='disabled',width=80,height=1,font=('楷体',10,'bold'))
...
if __name__=='__main__':                    
    tp = typing()
    tp.string_all.close()
e2=Entry(hh,textvariable=v2,state='disabled',width=80,font=('楷体',10,'bold'))
